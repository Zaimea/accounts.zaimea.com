...
use Zaimea\Groups\Group\Authorization\Authorization;
...
class ApiTokenManager extends Component
{
    ...
    {
        $this->createApiTokenForm['permissions'] = Authorization::$defaultPermissions;
    }
    ...
    public function createApiToken()
    {
        ...
        $this->displayTokenValue($this->user->createToken(
            ...
            Authorization::validPermissions($this->createApiTokenForm['permissions'])
        ));
    ...
    public function updateApiToken()
    {
        $this->managingPermissionsFor->forceFill([
            'abilities' => Authorization::validPermissions($this->updateApiTokenForm['permissions']),
        ])->save();

        $this->managingApiTokenPermissions = false;
        $this->reset('managingPermissionsFor');
    }
    ...
    {
        return view('users.api.api-token-manager');
    }
}
